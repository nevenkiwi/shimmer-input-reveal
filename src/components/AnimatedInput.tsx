...
const placeholders = [
  "Try asking... How to request a refund for your flight?",
  "Try asking... How to change your travel ID number?",
  "Try asking... How to check-in online with the airline?",
  "Try asking... How to request special assistance?"
];
    ...
    >
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className={cn(
            "flex-1 h-14 bg-transparent border-none outline-none text-gray-700 dark:text-gray-200 px-2",
            "placeholder:text-gray-500 dark:placeholder:text-gray-400",
            isChangingPlaceholder && "animate-fade-out"
          )}
